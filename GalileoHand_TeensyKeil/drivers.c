...
void UART1_Config(void){
	...
	UART1->BDH = UART_BDH_SBR(0x01);
	UART1->BDL = UART_BDL_SBR(0xD4);																																			//115200 bauds - 0x0027, 9600 bauds - 0x1D4
	UART1->C4 = UART_C4_BRFA(0x02);																																				//115200 bauds - 0x0027, 9600 bauds - 0x1D4																										
